...
Finding the right material to read or for last minute revision can be tough sometimes scrolling through various study material groups on WhatsApp, Opening and navigating multiple GDrives or even finding the PDFs lost in the File Manager app so to solve that I made Materio plus it saves storage not having to download Multiple PDFs on Device.
