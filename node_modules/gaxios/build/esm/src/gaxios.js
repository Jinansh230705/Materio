    ...
    async _request(opts) {
        try {
            ...
            if (!opts.validateStatus(translatedResponse.status)) {
                ...
                throw new GaxiosError(`Request failed with status code ${translatedResponse.status}`, opts, translatedResponse);
            }
            return translatedResponse;
        }
        catch (e) {
            const err = e instanceof GaxiosError
                ? e
                : new GaxiosError(e.message, opts, undefined, e);
