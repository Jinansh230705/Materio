 // JavaScript for tab switching
        ...
        const subjects = {
            ...
            '4': {
                'Operating System':['Syllabus', 'Syllabus-lab', 'Introduction', 'Processes, Thread & Process Scheduling', 'Inter-Process Communication','Deadlocks', 'Memory Management', 'Virtual Memory', 'IO Systems', 'IO Systems, File & Disk Management','Assignment -1','Assignment -1.1','Assignment -2','Assignment -2.1','Question Bank Unit 1 - 3', '28-12-17','11-06-18','12-12-18','27-05-19'],
                'Computer Organization and Microprocessor':['Syllabus', 'Syllabus-Lab', 'Introduction to Microprocessor 8085', 'Instruction Set of 8085','Microprocessor Architecture and Interfacing - 1','Microprocessor Architecture and Interfacing - 2', 'Programming Methods with Instructions', 'Additional Programming Techniques', '8085 Interrupts', 'Computer Organization - Register Transfer and Basic Computer Design Register Transfer','Computer Organization - Assembler and Memory Organization','Assignment 1','Assignment 2', 'Short and Long Answers','Question Bank with Answers','Microprocessor (8085) and its Applications - Book','04-10-21','08-08-22','12-10-22','30-03-22','29-01-24',],
                ...
                'Programming in Python with Full Stack':['Syllabus','Syllabus-lab', 'Introduction to Python Programming', 'Functions', 'Modules and Packages', 'Flask Framework', 'Django Framework', 'RESTful APIs', 'Question Bank - 1', 'Question Bank -2','Mid Sem Question Bank with Answers'],
                'Probability, Statistics and Numerical Methods':['Syllabus', 'Correlation, Regression and Curve fitting', 'Probability and Probability Distributions','Solution of a System of Linear Equations, Roots of Algebraic and Transcendental Equations', 'Testing of Hypothesis', 'Finite Differences and Interpolation', 'Numerical Integration','Tutorial 1', 'Tutorial 2', 'Assignment 1', 'Assignment 1A','Assignment 2', 'Normal Table', '12-02-21','12-03-21','06-04-22','01-05-24'],
